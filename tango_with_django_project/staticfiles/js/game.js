...
document.querySelectorAll('.map-tile').forEach(tile => {
  let posX = tile.getAttribute("data-position-x") || 1;
  let posY = tile.getAttribute("data-position-y") || 1;
  tile.style.gridColumn = parseInt(posX);
  tile.style.gridRow = parseInt(posY);
});
